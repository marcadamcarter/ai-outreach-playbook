...
See [core-model.md](core-model.md) for full descriptions.
...
This keeps the sponsor's core team out of operational work while giving them message control and measurement.

### What sponsors can fund

**Interactive Booth Kit** (physical): Flyers, FAQ handout, QR cards, stickers, table signage, talk-track card, setup instructions. Optional upgrades: retractable banner, tablecloth, volunteer shirts.

**Static Presence / Signal Actions materials**: Posters, QR sticker rolls, professionally printed corrugated plastic signs, vinyl banners.

**Digital Amplification infrastructure**: Dedicated landing page, QR generation with per-campaign tracking, analytics dashboard, short video production.

**Micro-Gatherings support**: Professional slide deck, printed handouts in quantity, QR cards for session follow-up.

**Institutional Touchpoints materials**: Professional briefing deck, printed leave-behind, speaker prep support.

Each kit has a version number and kit ID for tracking and iteration.

---

## How volunteers engage

Volunteers pick the mode that fits their situation:
- 30 minutes and a sign → Signal Actions
- Coffee shop access → Micro-Gathering
- Event booth → Interactive Booth
- No coordination wanted → Individual Advocacy
- Institutional access → Institutional Touchpoints

Most volunteers start at one mode and expand. City Leads coordinate the higher-effort modes.
...
- After-action reports (standardized template; submitted within 72 hours)
- Conversions defined by sponsor goal (subscribe, join, attend, donate, etc.)
...
This repo is organization-neutral. Different initiatives can ship their own kit variant and landing page while using the same operational playbook, volunteer infrastructure, and reporting structure. Sponsors with different tones and calls-to-action benefit from the same local volunteer base.
