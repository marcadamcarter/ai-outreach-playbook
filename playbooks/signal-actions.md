...
- [Static Presence](static-presence.md) — leave materials at the location after your session
- [Interactive Booths](interactive-booths.md) — upgrade to sustained engagement with a table setup
- [Digital Amplification](digital-amplification.md) — the QR destination your signs point to
